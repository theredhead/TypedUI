...
(function (_tests) {
    var ScrollViewWindow = (function (_super) {
        ...
        function ScrollViewWindow(aRect) {
            ...
            img.autoresizingMask = 1 /* LockedTop */ | 8 /* LockedRight */ | 4 /* LockedBottom */ | 2 /* LockedLeft */;
    ...
    var TestsController = (function () {
        function TestsController(tests) {
            ...
            var win = new red.Window(red.RectMake(0, 0, 200, 300)), content = win.contentView.addSubview(new red.ScrollView(win.frame.copy())), y = 0, h = 32, test;
            ...
            for (var ix = 0; ix < this._tests.length; ix++) {
                ...
                button.element.addEventListener('click', (function (tc) {
                    return function (e) {
                        alert('foo');
                        setTimeout(function () {
                            tc.showWindow();
