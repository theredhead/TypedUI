...
(function (red) {
    ...
    var Rect = (function () {
        ...
        Rect.prototype.intersects = function (other) {
            ...
            return dx < ((this.size.width / 2) || dx < (other.size.width / 2)) && dy < ((this.size.height / 2) || dy < (other.size.height / 2));
        };
    ...
    */
    ...
    var SplitViewAdjustManager = (function () {
        function SplitViewAdjustManager(e, view) {
            ...
            if (this.view.orientation == 0 /* Horizontal */) {
    ...
    var SplitView = (function (_super) {
        ...
        function SplitView(aRect) {
            ...
            this._orientation = 0 /* Horizontal */;
        ...
        Object.defineProperty(SplitView.prototype, "splitterPosition", {
            get: function () {
                if (this._splitterPosition == -1) {
                    return this.orientation == 0 /* Horizontal */ ? this.frame.size.height / 2 : this.frame.size.width / 2;
                }
        ...
        SplitView.prototype.applyFrameHorizontal = function () {
            var pos = this._splitterPosition = this._splitterPosition == -1 ? this.frame.size.width / 2 : this._splitterPosition;
        ...
        SplitView.prototype.applyFrameVertical = function () {
            var pos = this._splitterPosition = this._splitterPosition == -1 ? this.frame.size.height / 2 : this._splitterPosition;
            ...
            this.contentView2.frame = RectMake(0, this.splitterView.frame.origin.y + this.splitterView.frame.size.height, this.frame.size.width, this.frame.size.width - (this.splitterView.frame.origin.y + this.splitterView.frame.size.height));
        };
...
(function (_tests) {
    ...
    var Ball = (function (_super) {
        ...
        Ball.prototype.isHorizontallyCollidingWith = function (other) {
            return (this.x + this.r) >= (other.x - other.r) && (this.x - this.r) <= (other.x + other.r);
        };

        Ball.prototype.isVerticallyCollidingWith = function (other) {
            return (this.y + this.r) >= (other.y - other.r) && (this.y - this.r) <= (other.y + other.r);
        };
