    ...
    */
    ...
    var StackView = (function (_super) {
        ...
        StackView.prototype.applyStacking = function () {
            var subViews = this.subViews, subView, x, y, h, w, margin = this.margin, height = Math.round((this.frame.size.height - (subViews.length * margin)) / subViews.length);

            for (var ix = 0; ix < subViews.length; ix++) {
                subView = subViews[ix];
                x = margin;
                y = margin + (ix * (margin + height));
...
(function (_tests) {
    ...
    var StackViewTest = (function (_super) {
        __extends(StackViewTest, _super);
        function StackViewTest() {
            _super.apply(this, arguments);
        }
        StackViewTest.prototype.init = function () {
            _super.prototype.init.call(this);
        ...
        StackViewTest.prototype.applyFrame = function () {
